...
const FORMAT_SPECS: Record<SocialFormat, FormatSpec> = {
  ig_feed_4_5: {
    ...
    titleFontSize: 96, titleMaxCharsPerLine: 22, titleMaxTotalChars: 80,
  ...
  ig_square_1_1: {
    ...
    titleFontSize: 84, titleMaxCharsPerLine: 24, titleMaxTotalChars: 70,
  ...
  ig_story_9_16: {
    ...
    titleFontSize: 108, titleMaxCharsPerLine: 22, titleMaxTotalChars: 120,
